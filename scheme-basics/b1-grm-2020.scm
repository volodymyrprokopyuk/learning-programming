...
(use-modules (srfi srfi-42)) ;; Eager comprehensions

;; Eager comprehensions
;; (do-ec (: i 5) (pp i))
;; (pp (list-ec (: i 5) (* i i)))
;; (pp (append-ec (: i 5) (make-list i i)))
;; (pp (string-ec (: i 5) #\a))
;; (pp (string-append-ec (: i 5) "a"))
;; (pp (vector-ec (: i 5) (* i 10)))
;; (pp (fold-ec 0 (: i 5) i +))
;; (pp (fold3-ec 0 (: i 5) i (lambda (x) (+ x 100)) +))
;; (pp (fold-ec 1 (: i 1 5) i *))
;; (pp (list-ec (: i 5) (if (even? i)) i))
;; (pp (list-ec (: i 5) (not (even? i)) i))
;; (pp (list-ec (: i 5) (begin (pp i) i) i))
;; (pp (list-ec (:string c (index i) "abc" "def") (cons c i)))
;; (pp (list-ec (:list e '(1 2 3) '(4 5 6)) e))
;; (pp (list-ec (:vector e #(1 2 3) #(4 5 6)) e))
;; (pp (list-ec (:range i -1 -5 -1) i))
;; (pp (list-ec (:real-range r 0.0 1.0 0.1) r))
;; (pp (list-ec (:char-range c #\a #\z) c))
;; (pp (list-ec (: i 4) (: j 4) (list i j)))
;; (pp (list-ec (: i 5) (: j i) (list i j)))
;; (pp (list-ec (:parallel (: i 5) (: j 5)) (list i j)))
